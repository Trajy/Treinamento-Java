...
public class AmbienteDeTrabalhoTest {
	...
	@Test(expected = IllegalStateException.class)
	public void test_08_validar_nome_com_chars_repetidos() {
		ambienteDeTrabalhoTodosOsAtributos.setNome(TEXTO_COM_CHARS_REPETIDOS);
	}
	
	@Test(expected = IllegalArgumentException.class)
	public void test_09_validar_tipo_de_estabelecimento_nulo() {
		ambienteDeTrabalhoTodosOsAtributos.setTipoEstabelecimento(NULO);
	}
	
	@Test(expected = IllegalStateException.class)
	public void test_10_validar_tipo_de_estabelecimento_vazio() {
		ambienteDeTrabalhoTodosOsAtributos.setTipoEstabelecimento(VAZIO);
	}
	
	public void test_11_validar_tipo_de_estabelecimento_somente_com_espacos() {
		ambienteDeTrabalhoTodosOsAtributos.setTipoEstabelecimento(ESPACOS);
	}
	
	@Test(expected = IllegalStateException.class)
	public void test_12_validar_tipo_de_estabelecimento_com_char_nao_alfanumerico() {
		ambienteDeTrabalhoTodosOsAtributos.setTipoEstabelecimento(TEXTO_COM_CHAR_NAO_ALFANUMERICO);
	}
	
	@Test(expected = IllegalStateException.class)
	public void test_13_validar_tipo_de_estabelecimento_com_maximo_de_chars_nome() {
		ambienteDeTrabalhoTodosOsAtributos.setTipoEstabelecimento(TEXTO_COM_71_CHARS);
	}
	
	@Test(expected = IllegalStateException.class)
	public void test_14_validar_tipo_de_estabelecimento_com_chars_repetidos() {
		ambienteDeTrabalhoTodosOsAtributos.setNome(TEXTO_COM_CHARS_REPETIDOS);
	}
	
	@Test(expected = IllegalArgumentException.class)
	public void test_15_validar_endereco_nulo() {
		ambienteDeTrabalhoTodosOsAtributos.setEndereco(null);
	}
	
	@Test(expected = IllegalArgumentException.class)
	public void test_16_validar_responsavel_nulo() {
		ambienteDeTrabalhoTodosOsAtributos.setResponsavel(NULO);
	}
	
	@Test(expected = IllegalStateException.class)
	public void test_17_validar_responsal_vazio() {
		ambienteDeTrabalhoTodosOsAtributos.setResponsavel(VAZIO);
	}
	
	public void test_18_validar_responvel_somente_com_espacos() {
		ambienteDeTrabalhoTodosOsAtributos.setResponsavel(ESPACOS);
	}
	
	@Test(expected = IllegalStateException.class)
	public void test_19_validar_responsavel_com_char_nao_alfanumerico() {
		ambienteDeTrabalhoTodosOsAtributos.setResponsavel(TEXTO_COM_CHAR_NAO_ALFANUMERICO);
	}
	@Test(expected = IllegalStateException.class)
	public void test_20_validar_responsavel_com_char_nao_alfanumerico() {
		ambienteDeTrabalhoTodosOsAtributos.setResponsavel(TEXTO_COM_CHAR_NAO_ALFANUMERICO);
	}
	
	@Test(expected = IllegalStateException.class)
	public void test_21_validar_responsavel_com_numeros() {
		ambienteDeTrabalhoTodosOsAtributos.setResponsavel(TEXTO_COM_CHAR_NUMERICO);
	}
	
	@Test(expected = IllegalStateException.class)
	public void test_22_validar_responsavel_com_chars_repetidos() {
		ambienteDeTrabalhoTodosOsAtributos.setResponsavel(TEXTO_COM_CHARS_REPETIDOS);
	}
	
	@Test(expected = IllegalStateException.class)
	public void test_23_validar_responsavel_tamanho_maximo() {
		ambienteDeTrabalhoTodosOsAtributos.setResponsavel(TEXTO_COM_51_CHARS);
	}
	
	@Test(expected = IllegalStateException.class)
	public void test_24_validar_responsavel_de_tamanho_minimo() {
		ambienteDeTrabalhoTodosOsAtributos.setResponsavel(TEXTO_COM_2_CHARS);
	}
	
	@Test
	public void test_25_validar_metodo_hashcode_da_classe_ambiente() {
		assertThat(ambienteDeTrabalhoAtributosObrigatorios.hashCode(), equalTo(ambienteDeTrabalhoTodosOsAtributos.hashCode()));
	}

	@Test
	public void test_26_validar_metodo_equals_ambiente_com_ambiente() {
		assertTrue(ambienteDeTrabalhoAtributosObrigatorios.equals(ambienteDeTrabalhoTodosOsAtributos));
	}
	
	@Test
	public void test_27_validar_metodo_equals_de_ambiente_com_objeto_de_outra_classe() {
		assertFalse(ambienteDeTrabalhoTodosOsAtributos.equals(ENDERECO));
	}
	
	@Test
	public void test_28_validar_metodo_equals_de_ambiente_com_nulo() {
		assertFalse(ambienteDeTrabalhoAtributosObrigatorios.equals(NULO));	
	}
	
	@Test
	public void test_29_validar_metodo_equals_de_ambiente_com_outro_objeto_da_mesma_classe() {
	...
	public void test_30_validar_metodo_to_string_da_classe_ambiente() {
		assertThat(ambienteDeTrabalhoTodosOsAtributos.toString(), equalTo(outroAmbienteDeTrabalhoTodosOsAtributos.toString()));
	}
