...
public class Funcionario {
	...
	public String toString() {
		return "Funcionario [cpf=" + cpf + ", nome=" + nome + ", dataNascimento=" + dataNascimento + ", rg=" + rg
				+ ", endereco=" + endereco + ", setor=" + setor + ", cargo=" + cargo + ", ambienteTrabalho="
				+ ambienteTrabalho + ", telefones=" + telefones + ", emails=" + emails + ", salario=" + salario + "]";
	}
